...
const rules: Rule[] = [
  ...
  { category: "sport", subcategory: "Surf & sports de glisse",
    match: (t) => has(t, "sport", ["surfing", "kitesurfing"]) || t.leisure === "surf_school" },
  { category: "sport", subcategory: "Sports nautiques",
    match: (t) => has(t, "sport", ["canoe", "sailing", "scuba_diving"]) || t.leisure === "marina" },
  { category: "sport", subcategory: "Sports aériens",
    match: (t) => has(t, "sport", ["paragliding", "parachuting"]) },
  { category: "sport", subcategory: "Escalade & via ferrata",
    match: (t) => has(t, "sport", ["climbing", "via_ferrata"]) },
  ...
  { category: "vie-nocturne", subcategory: "Boîtes de nuit & clubs",
    match: (t) => t.amenity === "nightclub" },
  { category: "vie-nocturne", subcategory: "Salles de concert & live music",
    match: (t) => has(t, "amenity", ["music_venue", "concert_hall"]) },
